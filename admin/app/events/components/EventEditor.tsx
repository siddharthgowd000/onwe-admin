...
interface EventEditorProps {
  ...
  onSubmit: (updatedEvent: EventData) => void;
  onClose: () => void;
}

const EventEditor: React.FC<EventEditorProps> = ({ event, onSubmit, onClose }) => {
  ...
  return (
    <form className="flex flex-col p-5 text-xs font-semibold bg-white rounded-xl shadow-sm w-[450px] text-zinc-900" onSubmit={handleSubmit}>
      <img
        ...
        onClick={onClose}
      />
      <h1 className="mt-2.5 text-xl text-center">Edit Event</h1>
